...
Review the script for clarity, ensure all visual beats align with the storyboard, and verify that each caption is clear and concise. Adjust as needed to maintain a credible tone without false promises.
...
- Verify all asset clearance and brand approval.
- Ensure that the reel adheres strictly to the tone of being sharp, practical, and credi
