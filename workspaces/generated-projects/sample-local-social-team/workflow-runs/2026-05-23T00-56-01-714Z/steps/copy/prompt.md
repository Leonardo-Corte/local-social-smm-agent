...
## Task
Review only drafts/posts.md. Propose better hooks, claims, CTAs, and a complete replacement only for drafts/posts.md. Do not include carousel or reel content in the Proposed Artifact.
